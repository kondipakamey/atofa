...
<div class="container container-ajusted well">
	<div class="row well">
		<h3 class="text-center ">Créer un compte vous offre la possibilité et la flexibilité dans la gestion de vos annonces.</h3>	
	</div>
	<div class="row">
		<div class=" col-sm-8 container-ajusted">
			
			<div class="panel panel-primary">	
				
				<div class="panel-body"> 
					<div class="col-sm-12">
						{!! Form::open(['url' => 'enregistrer_compte', 'method' => 'post', 'class' => 'form-horizontal panel', 'files' => true]) !!}	
